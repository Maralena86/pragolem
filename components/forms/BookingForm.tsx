 ...
 */
function createInitialBookingValues(defaultLanguage: "en" | "fr"): BookingFormValues {
  return {
    tourSlug: "",
    date: "",
    timeSlot: "",
...
export function BookingForm({
  ...
  const [values, setValues] = useState<BookingFormValues>(() => createInitialBookingValues(defaultLanguage));
    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-5">
      <FieldGroup>
        <Field>
          ...
          <Select value={values.tourSlug} onValueChange={(value) => updateField("tourSlug", value)}>
            <SelectTrigger id="booking-tour" aria-invalid={Boolean(errors.tourSlug)}>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <Field>
            <FieldLabel htmlFor="booking-time-slot">{t("timeSlotLabel")}</FieldLabel>
            <Select value={values.timeSlot} onValueChange={(value) => updateField("timeSlot", value)}>
              <SelectTrigger id="booking-time-slot" aria-invalid={Boolean(errors.timeSlot)}>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field>
            <FieldLabel htmlFor="booking-participants">{t("participantsLabel")}</FieldLabel>
            <Select value={values.participants} onValueChange={(value) => updateField("participants", value)}>
              <SelectTrigger id="booking-participants" aria-invalid={Boolean(errors.participants)}>
          ...
          <Field>
            <FieldLabel htmlFor="booking-language">{t("languageLabel")}</FieldLabel>
            <Select value={values.language} onValueChange={(value) => updateField("language", value)}>
              <SelectTrigger id="booking-language" aria-invalid={Boolean(errors.language)}>
        ...
        <Field>
          <FieldLabel htmlFor="booking-full-name">{t("fullNameLabel")}</FieldLabel>
          <Input
        ...
        <Field>
          <FieldLabel htmlFor="booking-special-requests">{t("specialRequestsLabel")}</FieldLabel>
          <Textarea
