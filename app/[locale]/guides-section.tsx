				...
				{guides.map((guide) => (
					<Card key={guide.id}>
						...
						<CardContent className="space-y-3">
							...
							<div className="flex flex-col min-[1000px]:flex-row h-auto min-[1000px]:h-[200px] gap-3">
								<div className="relative h-[200px] w-full min-[1000px]:h-full min-[1000px]:w-[170px] shrink-0 mx-auto min-[1000px]:mx-0">
									<Image
