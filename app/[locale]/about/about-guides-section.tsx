  ...
  return (
    <section className="space-y-5">
      <div className="space-y-2">
        <h2 className="text-2xl font-semibold tracking-tight">{t("guides.title")}</h2>
            ...
            <Card key={guide.id}>
              <CardContent className="grid gap-4 pt-4 md:grid-cols-[160px_1fr]">
                ...
                <div className="space-y-3">
                  <div>
                    <h3 className="text-lg font-medium">{guide.attributes.name}</h3>
                    <p className="text-muted-foreground">{guide.attributes.role}</p>
                  </div>
