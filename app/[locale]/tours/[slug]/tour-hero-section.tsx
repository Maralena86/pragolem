  ...
  return (
    <section className="grid gap-6 border-b pb-10 md:grid-cols-[1.1fr_0.9fr] md:items-end">
      <div className="space-y-4">
        ...
        <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">{tour.attributes.title}</h1>
        <p className="max-w-2xl text-muted-foreground">{tour.attributes.shortDescription}</p>
        <div className="flex flex-wrap gap-2">
          <Button asChild>
          ...
          <Button variant="ghost" asChild>
            <Link
              ...
              href={{ pathname: "/tours/[slug]", params: { slug: tour.slug[alternateLocale] } }}
            >
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <Card size="sm">
          <CardHeader>
            ...
            <CardTitle>
              {tour.attributes.languages.map((language) => languageLabels[language] ?? language).join(", ")}
            </CardTitle>
          </CardHeader>
        </Card>
        <Card size="sm">
